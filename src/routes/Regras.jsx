  ...
  return (
    ...
    <div>
      ...
      <div className="button-container">
        <button className='botao-regras' onClick={handleRegrasFormulaE}>Regras da Fórmula E</button>
        <button className='botao-regras' onClick={handleRegrasEMasters}>Regras do eMasters</button>
      </div>
    </div>
    </RegrasStyle>
  );
