      ...
      <main>
        ...
        <section>
          ...
          <ul className="rules-list">
            <li>
              (1) Equipe Vencedora: A soma da pontuação dos dois pilotos da
            ...
            <li>
              (3) Cada piloto entre os 10 primeiros que forem acertados o
            ...
            <li>
              (6) Volta Mais Rápida: Acertar o piloto que faz a volta mais
        ...
        <section>
          ...
          <p>
            ...
            3ºlugar - 1.5 pontos 4ºlugar - 1 ponto 5ºlugar - 0.5 ponto (2)
            Acerto de Posições: Cada colocação correta rende 5 pontos. Exemplo:
            se o jogador acertar o 1ºlugar, o 3º lugar e o 9ºlugar. Ele acumula
            15 pontos. (3) Cada piloto entre os 10 primeiros que forem acertados
            o jogador ganha 2.5 pontos. Exemplo: se o jogador acertar 7 dos 10
            primeiros colocados, ele ganha 17.5 pontos. (4) Vencedor: Acertar o
            vencedor dobra a pontuação desse piloto. (5) Penalidade por
            Desqualificação: Escalar um piloto que não completa a corrida
            resulta em -2.5 pontos. (6) Volta Mais Rápida: Acertar o piloto que
            faz a volta mais rápida concede 5 pontos. (7) Ultrapassagens: Cada
